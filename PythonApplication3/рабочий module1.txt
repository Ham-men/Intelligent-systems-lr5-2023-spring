...
def find_fig(contours,mask,col):
    ...
    for cnt in contours:
        ...
        if h > 28:
            try:
                ...
                if(result=='Circle'):
                    figure_circle=figure_circle+1
                if(result=='Hexagon'):
                    figure_hexagon=figure_hexagon+1
                if(result=='Lightning'):
                    figure_lightning=figure_lightning+1
                if(result=='Triangle'):
                    figure_triangle=figure_triangle+1
                if(result=='Think'):
                    figure_think=figure_think+1
                if(result=='Star'):
                    figure_star=figure_star+1
                if(result=='Rectangle'):
                    figure_rectangle=figure_rectangle+1
    ...
    print("кол-во Circle = {}".format(figure_circle))
    print("кол-во Hexagon = {}".format(figure_hexagon))
    print("кол-во Lightning = {}".format(figure_lightning))
    print("кол-во Triangle = {}".format(figure_triangle))
    print("кол-во Think = {}".format(figure_think))
    print("кол-во Star = {}".format(figure_star))
    print("кол-во Rectangle = {}".format(figure_rectangle))
